package com.ichaabane.book_network.presentation.handler;
...
import static com.ichaabane.book_network.presentation.handler.BusinessErrorCodes.ACCOUNT_DISABLED;
        ...
        return ResponseEntity
                ...
                .body(
                        ExceptionResponse.builder()
                                ...
                                .businessErrorDescription("FORBIDDEN")
...
//
    ...
    @ExceptionHandler(CodeNotVerifiedException.class)
    public ResponseEntity<ExceptionResponse> handleException(CodeNotVerifiedException exp) {
        return ResponseEntity
                .status(FORBIDDEN)
                .body(
                        ExceptionResponse.builder()
