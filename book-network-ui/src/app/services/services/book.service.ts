...
import { cancelReservation } from '../fn/book/cancel-reservation';
import { CancelReservation$Params } from '../fn/book/cancel-reservation';
...
import { getMyReservations } from '../fn/book/get-my-reservations';
import { GetMyReservations$Params } from '../fn/book/get-my-reservations';
import { PageResponseBookResponse } from '../models/page-response-book-response';
import { PageResponseBorrowedBookResponse } from '../models/page-response-borrowed-book-response';
import { reserveBook } from '../fn/book/reserve-book';
import { ReserveBook$Params } from '../fn/book/reserve-book';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `reserveBook()` */
  static readonly ReserveBookPath = '/books/reservations/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `reserveBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  reserveBook$Response(params: ReserveBook$Params, context?: HttpContext): Observable<StrictHttpResponse<{
[key: string]: string;
}>> {
    return reserveBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `reserveBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  reserveBook(params: ReserveBook$Params, context?: HttpContext): Observable<{
[key: string]: string;
}> {
    return this.reserveBook$Response(params, context).pipe(
...
[key: string]: string;
  ...
  static readonly CancelReservationPath = '/books/reservations/{book-id}';
...
[key: string]: string;
  ...
  /** Path part for operation `getMyReservations()` */
  static readonly GetMyReservationsPath = '/books/reservations';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getMyReservations()` instead.
   *
   * This method doesn't expect any request body.
   */
  getMyReservations$Response(params?: GetMyReservations$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBookResponse>> {
    return getMyReservations(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `getMyReservations$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getMyReservations(params?: GetMyReservations$Params, context?: HttpContext): Observable<PageResponseBookResponse> {
    return this.getMyReservations$Response(params, context).pipe(
      map((r: StrictHttpResponse<PageResponseBookResponse>): PageResponseBookResponse => r.body)
    );
  }
