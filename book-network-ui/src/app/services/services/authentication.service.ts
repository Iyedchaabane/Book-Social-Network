...
import { verifyResetCode } from '../fn/authentication/verify-reset-code';
import { VerifyResetCode$Params } from '../fn/authentication/verify-reset-code';
...
export class AuthenticationService extends BaseService {
  ...
  /** Path part for operation `verifyResetCode()` */
  static readonly VerifyResetCodePath = '/auth/verify-reset-code';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `verifyResetCode()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  verifyResetCode$Response(params: VerifyResetCode$Params, context?: HttpContext): Observable<StrictHttpResponse<{
[key: string]: string;
}>> {
    return verifyResetCode(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `verifyResetCode$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  verifyResetCode(params: VerifyResetCode$Params, context?: HttpContext): Observable<{
[key: string]: string;
}> {
    return this.verifyResetCode$Response(params, context).pipe(
